...
public final class PathTerminal {
    private let adapter: PathTerminalAdapter
    ...
    public func cancelActiveTransaction() async throws {
        throw PathError(code: .unsupportedOperation, message: "cancelActiveTransaction not yet implemented", recoverable: false)
    }
